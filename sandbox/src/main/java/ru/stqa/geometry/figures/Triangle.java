...
public record Triangle(double a, double b, double c) { // создал публичный класс треугольника с тремя свойствами
    ...
    @Override
    public boolean equals(Object o) { // проверка сравнение без учета порядка сторон треугольника
    ...
    @Override
    public int hashCode() {
        return 1; // упрощенный hashCode и временная реализация - можно одинаковый хеш, позже доработать (оптимизировать)
    }
}
